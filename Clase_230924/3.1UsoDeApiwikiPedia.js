...
async function buscarEnWikipedia() {
    ...
    try {
        ...
        if (resultados.length > 0) {
            ...
            document.getElementById('resultados').textContent = `Resultados de busqueda para "${terminoBusqueda}":`;
        ...
        document.getElementById('resultado').textContent = 'Error al obtener los datos de Wikipedia. ';
